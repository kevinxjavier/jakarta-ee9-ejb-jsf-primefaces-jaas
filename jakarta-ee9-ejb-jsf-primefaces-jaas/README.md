...
# Create a User
    ...
    $ $WILDFLY_HOME/bin/add-user.sh     # Select Application User, group: USER
    $ $WILDFLY_HOME/bin/add-user.sh     # Select Application User, group: USER,ADMIN
...
```
	...
	$ curl http://localhost:8080/jakarta-ee9-ejb-jsf-primefaces-jaas
	$ curl http://localhost:8080/jakarta-ee9-ejb-jsf-primefaces-jaas/index.jsf
```
